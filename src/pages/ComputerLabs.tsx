...
import { 
  ArrowLeft, Monitor, Network, Wifi, Server, Shield, Zap, Gauge, PenTool as Tool, RefreshCw, HardDrive, Database, Users, Laptop, CheckCircle2, ArrowRight, Wrench, FileCheck, HeartPulse, Settings 
} from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-primary/80 to-secondary/80">
          <div className="container mx-auto px-4 md:px-6 h-full flex flex-col justify-center">
            ...
            <p className="text-lg md:text-xl font-medium text-white max-w-2xl [text-shadow:_1px_1px_2px_rgba(0,0,0,0.3)]">
              Creating an environment that fosters learning, creativity, and productivity for students
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl mx-auto">
            <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12">
              <Monitor className="w-12 h-12 text-secondary mb-6" />
              <h2 className="text-2xl md:text-3xl font-bold text-secondary mb-6">
                Modern Learning Environment
              </h2>
              <p className="text-slate text-lg leading-relaxed mb-6">
                A well-designed computer lab setup creates an environment that fosters learning, creativity, and productivity for students. Each workstation is equipped with high-performance desktop computers or laptops, designed to handle a variety of educational software and coding environments.
              </p>
              <div className="flex items-center gap-4 p-4 bg-sand-light rounded-lg">
                <Network className="w-6 h-6 text-secondary" />
                <p className="text-secondary font-medium">
                  Powered by enterprise-grade networking infrastructure
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 md:py-24 bg-gradient-to-br from-primary-light to-accent-light relative overflow-hidden">
        <div className="absolute inset-0 bg-[url('/images/ComputerLab.jpg')] opacity-5 bg-cover bg-center"></div>
        <div className="container mx-auto px-6 relative z-10">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-secondary mb-4">Network Infrastructure</h2>
            <p className="text-slate text-lg max-w-2xl mx-auto">
              Robust networking solutions designed for educational excellence
            </p>
          </div>
